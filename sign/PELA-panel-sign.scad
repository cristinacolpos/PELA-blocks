...
module PELA_panel_sign(material, large_nozzle, cut_line, l, w, line_1, line_2, lang, extrude,  text_depth, f1, f2, fs1, fs2, left_margin, vertical_margin, top_vents, corner_bolt_holes, bolt_hole_radius, sockets, knobs, knob_height, knob_vent_radius, block_height) {
...
module PELA_flat_sign_extruded_text(material, large_nozzle, l, w, line_1, line_2, lang, extrude, text_depth, f1, f2, fs1, fs2, left_margin, vertical_margin, top_vents, corner_bolt_holes, sockets, knobs, block_height) {
...
module PELA_sign_extruded_text(material, large_nozzle, l, w, line_1, line_2, lang, text_depth, f1, f2, fs1, fs2, left_margin, vertical_margin, block_height) {
    ...
    translate([left_margin+_skin, -vertical_margin+block_width(w)-_skin, panel_height(block_height=block_height)-text_depth]) {
    ...
    translate([left_margin+_skin, vertical_margin+_skin, panel_height(block_height=block_height)-text_depth]) {
...
module PELA_sign_etched_text(material, large_nozzle, l, w, h, line_1, line_2, lang, text_depth, f1, f2, fs1, fs2, left_margin, vertical_margin, block_height) {
