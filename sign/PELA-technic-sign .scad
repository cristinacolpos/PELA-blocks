...
module PELA_technic_sign(material, large_nozzle, cut_line, l, w, h, twist_l, twist_w, center, line_1, line_2, lang, edge_text,  text_depth, f1, f2, fs1, fs2, left_margin, vertical_margin, top_vents, corner_bolt_holes, sockets, knobs, block_height) {
    ...
    difference() {
        union() {
            difference() {
                technic_box(material=material, large_nozzle=large_nozzle, cut_line=cut_line, l=l, w=w, h=h, twist_l=twist_l, twist_w=twist_w, center=center, sockets=sockets, knobs=knobs, text=edge_text, text_depth=text_depth, block_height=block_height);
