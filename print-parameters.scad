...
bottom_tweak = 0.1; // -0.02 for ABS (0.1 for thin), 0.10 for rPET, 0.08 for Pro1, 0.04 for Polymaker Polylite PLA, 0.08 for NGEN, 0.02 for NGEN Flex, -0.02 for Ninjaflex, 0.15 for Bridge Nylon, 0.04 for Ultimaker TPU95A, 0.0 Biofila Silk
