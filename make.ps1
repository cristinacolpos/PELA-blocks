...
render ".\slot-mount\" "PELA-slot-mount-30degree"
...
render ".\technics-bar\" "PELA-technics-bar"
render ".\technics-bar\" "PELA-technics-bar-30degree"
render ".\technics-bar\" "PELA-technics-bar-45degree"
render ".\technics-board-mount\" "PELA-technics-board-mount"
