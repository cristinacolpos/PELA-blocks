...
render ".\calibration\" "PELA-calibration-flex-large"
render ".\calibration\" "PELA-calibration-flex-small"
render ".\calibration\" "PELA-calibration-norm-large"
render ".\calibration\" "PELA-calibration-norm-small"
render ".\calibration\" "PELA-calibration-set-flex-large"
render ".\calibration\" "PELA-calibration-set-flex-small"
render ".\calibration\" "PELA-calibration-set-norm-large"
render ".\calibration\" "PELA-calibration-set-norm-small"
