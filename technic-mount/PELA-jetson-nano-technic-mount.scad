...
front_enclosure_cutout_x = 6.2; // [0:0.1:200]

// Width of the front side hole [mm]
front_enclosure_cutout_width = 100; // [0:0.1:200]

// Depth into the part of the front cut [mm]
front_enclosure_cutout_depth = 9; // [0:0.1:200]

// Distance from bottom of the front side hole [mm]
front_enclosure_cutout_z = 5; // [0:0.1:200]

// Height of the front side hole [mm]
front_enclosure_cutout_height = 32; // [0:0.1:200]
