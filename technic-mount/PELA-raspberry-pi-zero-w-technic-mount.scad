...
length = 65.4; // [0:0.1:300] 

// Board space width [mm]
width = 30.5; // [0:0.1:300]
...
left_enclosure_cutout_y = 12; // [0:0.1:200]

// Width of the left side hole [mm]
left_enclosure_cutout_width = 16; // [0:0.1:200]

// Depth of the left side hole [mm]
left_enclosure_cutout_depth = 10; // [0:0.1:200]

// Distance from bottom of the left side hole [mm]
left_enclosure_cutout_z = 0; // [0:0.1:200]

// Height of the left side hole [mm]
left_enclosure_cutout_height = 9; // [0:0.1:200]
...
front_enclosure_cutout_width = 56; // [0:0.1:200]
...
difference() {
    ...
    union() {
        color("orange") translate([block_width(l-1.5)-defeather, block_width(-5.5), block_height(0.5)]) {
