...
module bottom_negative_space(l=l, w=w, bottom_type=bottom_type, panel_height=bottom_height, skin=skin, solid_bottom_layer=solid_bottom_layer) {
...
module edge_connector_negative_space(l=l, w=w, bottom_type=bottom_type, panel_height=bottom_height, side_holes=side_holes, end_holes=end_holes, axle_hole_radius=axle_hole_radius, hole_type=side_holes, knob_radius=knob_radius, bolt_holes=bolt_holes) {
...
module enclosure_bottom(l=l, w=w, bottom_type=bottom_type, panel_height=panel_height, skin=skin, skip_edge_knobs=skip_edge_knobs, solid_bottom_layer=solid_bottom_layer) {
    if (bottom_type==1) {
