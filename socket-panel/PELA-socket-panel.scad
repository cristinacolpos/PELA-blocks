...
module PELA_socket_panel(l=l, w=w, panel_height=panel_height, bolt_holes=bolt_holes, bolt_hole_radius=bolt_hole_radius, skin=skin) {
    ...
    PELA_socket_panel_one_sided(l=l, w=w, panel_height=panel_height, top_vents=top_vents, solid_bottom_layer=solid_bottom_layer, bolt_holes=bolt_holes, bolt_hole_radius=bolt_hole_radius, knob_height=knob_height, skin=skin);
...
module PELA_socket_panel_one_sided(l=l, w=w, panel_height=panel_height, bolt_holes=bolt_holes, bolt_hole_radius=bolt_hole_radius, knob_height=knob_height, skin=skin) {
