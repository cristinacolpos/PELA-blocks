...
module technic_twist_bar(material=material, large_nozzle=large_nozzle, left=left, center=center, right=right) {
    ...
    if (center == 0) {
        technic_bar(material=material, large_nozzle=large_nozzle, l=left+right);
    } else {
