...
top_tweak = -0.05; // -0.04 for ABS, 0.04 for rPET, -0.06 for Pro1, -0.05 for Polymaker PLA, -0.03 for NGEN, 0.02 for NGEN Flex, 0.09 for Ninjaflex, -0.02 for Bridge Nylon, 0.02 for Ultimaker TPU95A, 0.0 Biofila Silk
...
bottom_tweak = 0.04; // -0.02 for ABS, 0.10 for rPET, 0.08 for Pro1, 0.04 for Polymaker PLA, 0.08 for NGEN, 0.02 for NGEN Flex, -0.02 for Ninjaflex, 0.15 for Bridge Nylon, 0.02 for Ultimaker TPU95A, -0.02 Biofila Silk
...
axle_hole_tweak = 0.06; // 0.04 for ABS, 0.04 for rPET, 0.04 for Pro1, 0.06 for Polymaker PLA, 0.04 for NGEN, 0 for NGEN Flex, 0.04 for Ninjaflex, 0.06 for Bridge Nylon, 0.04 for Ultimaker TPU95A, -0.04 Biofila Silk
