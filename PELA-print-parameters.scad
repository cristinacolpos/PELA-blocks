...
axle_hole_tweak = 0; // 0.04 for ABS, 0.04 for rPET, 0.04 for Pro1, 0.06 for Polymaker PLA, 0.04 for NGEN, 0 for NGEN Flex, 0.04 for Ninjaflex, 0.06 for Bridge Nylon, 0.04 for Ultimaker TPU95A, -0.04 Biofila Silk
