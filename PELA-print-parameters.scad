...
bottom_tweak = 0.06; // -0.02 for ABS, 0.10 for rPET, 0.08 for Pro1, 0.04 for Polymaker PLA, 0.06 for NGEN, 0.02 for NGEN Flex, -0.02 for Ninjaflex, 0.15 for Bridge Nylon, 0.02 for Ultimaker TPU95A, -0.02 Biofila Silk
